...
const definitions = [
  ...
  },
  {
    ...
    definition: "الطريق إلى اليقين هو رحلة شخصية تبدأ باستكشاف 'خارطة طريق رحلة اليقين'. تتضمن هذه الرحلة استخدام أدوات مثل 'مسارك الشخصي' للمساعدة بالذكاء الاصطناعي، والمشاركة في 'الأنشطة العملية' و 'المجتمع' لتحويل المعرفة إلى عمل."
  }
];
