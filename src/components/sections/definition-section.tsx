...
const definitions = [
  ...
  },
  {
    ...
    definition: "اليقين يوجد في القلب. تبدأ الرحلة بالتعرف عليه وتعلمه، ثم الإيمان به. بعد ذلك، يأتي دور اكتشاف واختبار وجوده في القلب عبر عبادات وطرق مختلفة. بما أن اليقين يزيد وينقص، فمن المهم الحفاظ على ما اكتسبته والمحافظة على حد أدنى منه، ليكون مؤشرًا لبدء رحلة جديدة للتزود به. إن عملية تعبئة القلب باليقين هي عملية مستمرة لا تنقطع إلا بالموت، حيث يتحول اليقين بالعمل إلى يقين بالجزاء والحساب."
  }
];
