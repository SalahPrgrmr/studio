...
const faqItems = [
  ...
  },
  {
    ...
    answer: "لأن الهدف هو إبلاغ الكافر بأن الله ربه وإنذاره بالعذاب ونشر كلمة 'لا إله إلا الله'. هذا الهدف إيماني ووجودي، وهو لا يهدف إلى إحداث فوضى أو التعصب، بل يدعو إلى الإيمان بالرب الذي يحترمه كل إنسان ويدعوه للعيش بكرامة وسلام. ولأننا نحترم כל الأديان والقناعات ولا نجبر أحداً، فنحن نبلغ الكلمة وننشرها، ومن أنكر فحسابه على الرب."
  },
  {
...
const coreSummary = {
  ...
  requirement: "فاعلم أنه لا إله إلا الله، وذكر بها، وبلغ بها جميع الإنس والجن.",
