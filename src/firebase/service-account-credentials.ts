...
// This check is crucial for server-side environments where these variables must be defined.
...
export const serviceAccount = {
  ...
  // Replace escaped newlines for environments that don't handle them automatically.
