...
const journeySteps = [
  ...
  },
  {
    ...
    description: 'بعد العلم بوجود الخالق، تأتي خطوة التفكر. من خلال مراقبة عظمة الكون ونظامه الدقيق، ترى بصمات الخالق الواحد في كل مكان، مما يعمق يقينك. تأمل في "آيات الكون" لترسيخ هذا الشعور.',
    link: '/cosmic-signs',
