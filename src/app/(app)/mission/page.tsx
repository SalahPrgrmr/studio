      ...
      <Card className="mb-16 shadow-lg bg-primary/5 border-primary/20">
        ...
        <CardContent>
            <p className="text-center text-lg md:text-xl leading-relaxed max-w-4xl mx-auto text-foreground">
                "عين اليقين" هي منصة دعوية عالمية، محايدة، وغير ربحية. مهمتها الأساسية هي التعريف بالله وبمفهوم التوحيد - "لا إله إلا الله"، وحده لا شريك له - والسعي للوصول إلى مستوى "عين اليقين" في هذا الفهم. ثم تهدف إلى إيصال هذه الرسالة الصافية إلى الناس كافة، بمختلف لغاتهم وثقافاتهم. هذه هي منصتكم أنتم أيها الإنسان، ونحن أُمرنا لنخدمكم. نحن نوفر الأدوات المعرفية، والمحتوى الموثوق، والمجتمع الداعم لمساعدة كل باحث عن الحقيقة على بناء قناعات راسخة تنير طريقه في الحياة.
            </p>
        </CardContent>
      </Card>
